...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: "WhatsApp",
      url: `https://wa.me/919436563207?text=${encodeURIComponent(
        "Hi Priyajit, I loved your project!"
      )}`,
      icon: (
        <svg
          className="w-5 h-5"
          ...
          <div className="col-span-1">
            ...
            <div className="mt-4">
              <p className="text-sm text-gray-300">
                Email: iampd10official@gmail.com
              </p>
              <p className="text-sm text-gray-300">Phone: +91 9436563207</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-sm text-gray-300 mt-2 md:mt-0">
              Created by <span className="text-blue-400">Priyajit Debnath</span>
            </p>
          </div>
        </div>
      </div>
